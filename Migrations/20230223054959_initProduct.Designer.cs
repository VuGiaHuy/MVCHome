...
namespace MyApp.Migrations
{
    ...
    [Migration("20230223054959_initProduct")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("App.Models.Product.PCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("App.Models.Product.ProductPCategory", b =>
                {
                    b.Property<int>("ProductId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("ProductId", "PCategoryId");

                    b.HasIndex("PCategoryId");

                    b.ToTable("ProductPCategory");
                });
            ...
            modelBuilder.Entity("App.Models.Product.PCategory", b =>
                {
                    b.HasOne("App.Models.Product.PCategory", "ParentCategory")
                        .WithMany("ChildrenCategory")
                        .HasForeignKey("ParentCategoryId");
            ...
            modelBuilder.Entity("App.Models.Product.ProductPCategory", b =>
                {
                    b.HasOne("App.Models.Product.PCategory", "Category")
                        .WithMany()
            ...
            modelBuilder.Entity("App.Models.Product.ProductModel", b =>
                {
                    b.Navigation("ProductPCategories");
                });
